...
public class DoctorJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        chk_A.setBackground(new java.awt.Color(0, 183, 210));
        chk_A.setForeground(new java.awt.Color(255, 255, 255));
        chk_A.setText("A Group");

        chk_AB.setBackground(new java.awt.Color(0, 183, 210));
        chk_AB.setForeground(new java.awt.Color(255, 255, 255));
        chk_AB.setText("AB Group");

        chk_O.setBackground(new java.awt.Color(0, 183, 210));
        chk_O.setForeground(new java.awt.Color(255, 255, 255));
        chk_O.setText("O Group");

        chk_B.setBackground(new java.awt.Color(0, 183, 210));
        chk_B.setForeground(new java.awt.Color(255, 255, 255));
